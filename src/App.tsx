...
export default function App() {
  ...
  const [detailsInitialTab, setDetailsInitialTab] = useState<'telemetry' | 'health' | 'fluctuations' | 'export'>('telemetry');
  ...
  const handleOpenModal = (modal: ActiveModal, initialTab: 'telemetry' | 'health' | 'fluctuations' | 'export' = 'telemetry') => {
    if (modal !== 'none') {
